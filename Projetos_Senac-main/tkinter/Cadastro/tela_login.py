...
bt0_fr0 = Button(fr0, text='Funcionário', font='Arial 25',width=10, command= lambda: [fr0.grid_remove(), fr1.grid(row=2, column=0)]).grid(row=1, column=0,sticky=W, padx=300)
bt1_fr0 = Button(fr0, text='Usuario', font='Arial 25',width=9, command= lambda: [fr0.grid_remove(), fr4.grid(row=2, column=0)]).grid(row=1, column=0,sticky=E, padx=305)
